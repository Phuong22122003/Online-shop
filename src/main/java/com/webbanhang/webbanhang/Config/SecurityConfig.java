...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity httpSecurity) throws Exception{
        httpSecurity.authorizeHttpRequests((request)->request
            // .requestMatchers("/file/image/**","/api/home/**","/js/**","/assets/**","/css/**").permitAll()
            // .requestMatchers("/login","/home","/product-detail/**").permitAll()
            // .requestMatchers("/api/authenticate","/api/login/isLoggedIn").permitAll()
    ...
    //             SubCategories client = new SubCategories();
